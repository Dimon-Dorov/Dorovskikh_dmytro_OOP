...
if (idx++ % (size / 2) == 0) {
    ...
    result /= size;
    System.out.println("Average P done. Result = " + String.format("%.2f",result));
    result = 0.0;
    progress = 0;
    idx = 1;
...
if (idx++ % (size / 2) == 0) {
    ...
    result /= size;
    System.out.println("Average S done. Result = " + String.format("%.2f",result));
    result = 0.0;
    progress = 0;
    idx = 1;
...
if (idx++ % (size / 2) == 0) {
    ...
    result /= size;
    System.out.println("Average V done. Result = " + String.format("%.2f",result));
    progress = 100;
    }
    /**
    @Override
